...
Every few months I back up that drive to a big external drive with one of: 
    ...
    rsync -aHAXv --exclude=lost+found --info=progress3 --size-only /home/joe/bigdisk/ /media/joe/1TB\ externa/bigdisk/ # (when I think I might have edited the archive a bit) 


...and store it securely.  About once I year I take that external drive to a secure external site and back it up there.  

TODO - I should make a log of roughtly how long each of those takes to do. 
