...
I've been teaching IY3501 (Security Management) since the 2024-2025 academic year and for the last two years I've been running full Question and Answer lecture.  This post contains my notes. 

I have a two-hour Friday lecture and, on two selected days each term, I brought zero slides and told the students that it would be a review lecture. For the next two hours, I would answer any questions about the material they'd been taught so far (in practice, I am generally willing to answer any question about the module; particularly because I get to say 'I don't know, can you tell me more about it'). 

Happily (I lacked any backup plan and told them as much), they went with it. For two hours, we did nothing but Q&A for a class of about 70 students. We talked about exceptions to particular rules, boundary cases, real-life examples, complex thought experiments, and a wide range of other things.
...
# Things I wanted to improve for the next year (and a mark if I did or not) 
* I want much more of a connection to the recommended reading. ❌ 
* The question database will need revision.  ✅  
* I want to improve the code with templates and more flexibility. ✅ (I certainly completely rewrote the code, but it was from a 'uggh this is ugly' perspective rather than adding any features)   
* I haven't got students to ask questions electronically very well. It's done well by some of the law lecturers; I'll remind myself how they do it. ✅ (but the students got the credit there were many many more questions by teams the second year) 
* I want the students to get a lot better at answering each other's questions. ❌  

# Things I changed for the second year. 
* I gave students ten minutes at the start of the session to think of questions. 
* The handout referenced this blog post and the feedback from previous students 
* I told the students it would be happening four days in advance (previously I'd sprung it on the students) 
* I didn't set any rules about when they could ask questions about coursework

None of these changes were particularly purposeful or led by design, they were natural updates.  
