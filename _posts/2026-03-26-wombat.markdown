...
For students who wanted to use LaTeX, I provided an example with the references in BibTeX and a bibliography style for WOMBAT. The files are here:

* [LaTeX source](/assets/latexexample-rhul.tex)
* [BibTeX references](/assets/refs.bib)
* [Bibliography style](/assets/rhul.bst)
* [Compiled PDF](/assets/latexexample-rhul.pdf)

Keep the three source files in the same folder if you want to try it yourself.
