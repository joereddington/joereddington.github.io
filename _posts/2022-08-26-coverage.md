...
Suddenly, many more pages are indexed. 177 in fact.  
...
I've updated the jekyll \_config file and will come back in a couple of weeks to see if it made a difference. My working assumption is that 'the sitemap has always been broken in this way but that Google didn't give error messages like this at the time; also, it's quietly indexed a bunch more pages in the background from various links'.  
